...
![Live on GitHub Pages](https://img.shields.io/badge/live-fritzhand.github.io%2Fcincy--week-1c1a17?style=flat-square&logo=githubpages&logoColor=white)
![Node ≥ 18](https://img.shields.io/badge/node-%E2%89%A5%2018-5FA04E?style=flat-square&logo=nodedotjs&logoColor=white)
![Zero dependencies](https://img.shields.io/badge/dependencies-zero-1f6f5c?style=flat-square)
![No tracking](https://img.shields.io/badge/analytics-none-1f6f5c?style=flat-square)
![Map data: OpenStreetMap](https://img.shields.io/badge/map%20data-OpenStreetMap%20(ODbL)-7ebc6f?style=flat-square&logo=openstreetmap&logoColor=white)
![License: MIT](https://img.shields.io/badge/license-MIT-b3452c?style=flat-square)

<br>

<a href="https://fritzhand.github.io/cincy-week/"><img src=".github/screenshots/hero-home.png" alt="The Cincy Week home page: the masthead over a line for the Ohio River, the lead story on the three festivals, and the countdown to Art Week" width="840"></a>
...
| | |
| --- | --- |
| ![The Week in the dark edition on Thursday, Oct 8: day tabs with program ticks, program filters, and "Now" badges on the evening's events](.github/screenshots/week-during-dark.png) | ![A StartupCincy speaker's page: headshot credited to StartupCincy, verbatim bio, and her sessions as event cards](.github/screenshots/person.png) |
| ![The map: a custom OpenStreetMap basemap with numbered venue pins, BLINK's route, and layer toggles for venues, art, stays, transit and food](.github/screenshots/map.png) | ![Three phone screens: "At this hour" on the home page, an event dialog marked Now, and the BLINK program page](.github/screenshots/phone.png) |
